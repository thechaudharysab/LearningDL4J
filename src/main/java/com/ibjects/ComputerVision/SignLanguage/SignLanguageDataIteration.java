...
public class SignLanguageDataIteration {
    ...
    private static final String dataDir = System.getProperty("java.io.tmpdir") + "signLangTemp";
    private static final String DATA_URL = "https://github.com/thechaudharysab/LearningDL4J/blob/master/src/main/resources/asl_dataset_digits.zip";
    ...
    private static void loadAndUnzipFile() throws IOException {
        ...
        File zipFile = new File(dataDir, "asl_dataset_digits.zip");
        FileUtils.copyURLToFile(new URL(DATA_URL), zipFile);
        ArchiveUtils.unzipFileTo(zipFile.getAbsolutePath(), dataDir);
